...
def create_app():
    ...
    app = FastAPI(
        ...
        license_info={
            "name": "Copyright(C), {{cookiecutter.devleopment_year}} xxx Private Limited. All Rights Reserved. Unauthorized access to this system is forbidden and will be prosecuted by law. By accessing this system, you agree that your actions may be monitored if unauthorized usage is suspected.",
